...
<div class="card-body p-sm-5 m-sm-3 flex-grow-0">
    ...
    <div class="fs-exact-14 text-muted mt-2 pt-1 mb-5 pb-2">{{ __('Please enter your new password.') }}</div>

    <form method="POST" action="{{ route('dashboard.password.store') }}" class="needs-validation" novalidate="">
        @csrf
