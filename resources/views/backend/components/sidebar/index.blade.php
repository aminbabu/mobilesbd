...
<div class="sa-app__sidebar">
    <div class="sa-sidebar">
        <div class="sa-sidebar__header">
            <a class="sa-sidebar__logo" href="{{ route('home') }}">
                <!-- logo -->
                <div class="sa-sidebar-logo">
                    <div class="navbar-brand text-dark fw-bold">{{ config('app.name') }}</div>
                    <div class="sa-sidebar-logo__caption">{{ __($user->role) }}</div>
                </div>
                <!-- logo / end -->
            </a>
        </div>
                    ...
                    <ul class="sa-nav__menu sa-nav__menu--root">
                        ...
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <a href="{{ route('admin.user.edit') }}" class="sa-nav__link">
                                ...
                                <li class="sa-nav__menu-item">
                                    <a href="app-customers-list.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ __('Users List') }}</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="app-customer.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ __('Your Profile') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                            ...
                            <a href="" class="sa-nav__link" data-sa-collapse-trigger="">
                                ...
                                <span class="sa-nav__title">{{ __('Catalog') }}</span>
                                <span class="sa-nav__arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                        viewBox="0 0 6 9" fill="currentColor">
                                        <path
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                <li class="sa-nav__menu-item">
                                    <a href="app-products-list.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ __('Products List') }}</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="app-product.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ __('Product') }}</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="app-categories-list.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ __('Categories List') }}</span>
                                    </a>
                                </li>
                                <li class="sa-nav__menu-item">
                                    <a href="app-category.html" class="sa-nav__link">
                                        <span class="sa-nav__menu-item-padding"></span>
                                        <span class="sa-nav__title">{{ __('Category') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                            ...
                            <a href="" class="sa-nav__link" data-sa-collapse-trigger="">
                                ...
                                <span class="sa-nav__title">{{ __('Customers') }}</span>
                                <span class="sa-nav__arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="6" height="9"
                                        viewBox="0 0 6 9" fill="currentColor">
                                        <path
