    ...
    <div class="sa-toolbar__body">
        ...
        <div class="sa-toolbar__item sa-toolbar__item--search">
            <form class="sa-search sa-search--state--pending">
                <div class="sa-search__body">
                    <label class="visually-hidden" for="input-search">{{ __('Search for:') }}</label>
                ...
                <div class="sa-search__dropdown">
                    ...
                    <div class="sa-search__dropdown-wrapper">
                        ...
                        <div class="sa-search__help sa-search__help--type--greeting">
                            <div class="sa-search__help-title">{{ __('Start typing to search for') }}</div>
                            <div class="sa-search__help-subtitle">{{ __('Products, orders, customers, actions, etc.') }}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="sa-toolbar__item dropdown">
            <button class="sa-toolbar__button" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown"
                ...
                <img src="{{ asset('backend/vendor/flag-icons/24/DE.png') }}" class="sa-language-icon" alt="" />
            </button>
            <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ asset('backend/vendor/flag-icons/24/DE.png') }}" class="sa-language-icon me-3"
                            alt="" />
                        <span class="ps-2">{{ __('German') }}</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ asset('backend/vendor/flag-icons/24/FR.png') }}" class="sa-language-icon me-3"
                            alt="" />
                        <span class="ps-2">{{ __('French') }}</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ asset('backend/vendor/flag-icons/24/GB.png') }}" class="sa-language-icon me-3"
                            alt="" />
                        <span class="ps-2">{{ __('English') }}</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ asset('backend/vendor/flag-icons/24/RU.png') }}" class="sa-language-icon me-3"
                            alt="" />
                        <span class="ps-2">{{ __('Russian') }}</span>
                    </a>
                </li>
                <li>
                    <a class="dropdown-item d-flex align-items-center" href="#">
                        <img src="{{ asset('backend/vendor/flag-icons/24/IT.png') }}" class="sa-language-icon me-3"
                            alt="" />
                        <span class="ps-2">{{ __('Italian') }}</span>
                    </a>
                </li>
            </ul>
        </div>
            ...
            <div class="dropdown-menu dropdown-menu-end py-0" aria-labelledby="dropdownMenuButton2">
                <div class="sa-notifications">
                    <div class="sa-notifications__header">
                        <div class="sa-notifications__header-title">{{ __('Notifications') }}</div>
                        <a class="sa-notifications__header-action" href="">{{ __('Mark All as Read') }}</a>
                    </div>
                    <ul class="sa-notifications__list">
                            ...
                            <a href="#" class="sa-notifications__item-button">
                                ...
                                <div class="sa-notifications__item-body">
                                    <div class="sa-notifications__item-title sa-notifications__item-title--nowrap">
                                        {{ __('New report has been received') }}
                                    </div>
                                    <div
                        ...
                        <li class="sa-notifications__item">
                            <a href="#" class="sa-notifications__item-button">
                                ...
                                <div class="sa-notifications__item-body">
                                    <div class="sa-notifications__item-title sa-notifications__item-title--nowrap">
                                        {{ __('Creating a backup in the process') }}
                                    </div>
                                    <div
                                        class="sa-notifications__item-subtitle sa-notifications__item-subtitle--nowrap">
                                        {{ __('Completed: 37% (23.05 MB)') }}
                                    </div>
                                </div>
                            </a>
                        </li>
                        <li class="sa-notifications__item">
                            <a href="#" class="sa-notifications__item-button">
                                ...
                                <div class="sa-notifications__item-body">
                                    <div class="sa-notifications__item-title sa-notifications__item-title--nowrap">
                                        {{ __('Product added to cart') }}</div>
                                    <div
                                        class="sa-notifications__item-subtitle sa-notifications__item-subtitle--nowrap">
                                        {{ __('Drill Screwdriver Brandix ALX7054 200 Watts') }}
                                    </div>
                                </div>
                            </a>
                        </li>
                        <li class="sa-notifications__item">
                            <a href="#" class="sa-notifications__item-button">
                                ...
                                <div class="sa-notifications__item-body">
                                    <div class="sa-notifications__item-title sa-notifications__item-title--nowrap">
                                        {{ __('Customer Ryan Ford says') }}</div>
                                    <div
                                        class="sa-notifications__item-subtitle sa-notifications__item-subtitle--nowrap">
                                        {{ __('What is a screen dimension of Brandix Series B monitor?') }}
                                    </div>
                                </div>
                            </a>
                        </li>
