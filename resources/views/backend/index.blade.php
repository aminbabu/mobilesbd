                            ...
                            <div class="saw-indicator__delta saw-indicator__delta--fall">
                                <div class="saw-indicator__delta-direction">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9"
                                        ...
                                        <rect x="0" y="2.5"
                                            transform="matrix(0.7071 0.7071 -0.7071 0.7071 3.5 -1.4497)" width="7.1"
                                            height="2"></rect>
                                    </svg>
                                </div>
                                ...
                                <ul class="sa-timeline__list">
                                    ...
                                    <li class="sa-timeline__item">
                                        ...
                                        <div class="sa-timeline__item-content">
                                            ...
                                            philosophy is associated with wisdom, intellectual culture and a search for
                                            knowledge.
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item py-2">
                                <div class="d-flex align-items-center py-3">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                        <div class="col">
                                            <a href="app-product.html" class="text-reset fs-exact-14">Wiper Blades Brandix
                                                WL2</a>
                            ...
                            <li class="list-group-item py-2">
                                <div class="d-flex align-items-center py-3">
                                    ...
                                    <div class="d-flex align-items-center flex-grow-1 flex-wrap">
                                        <div class="col">
                                            <a href="app-product.html" class="text-reset fs-exact-14">Brandix Router Power
                                                Tool 2017ERXPK</a>
                                            <div class="text-muted fs-exact-13">
                                                Reviewed by
