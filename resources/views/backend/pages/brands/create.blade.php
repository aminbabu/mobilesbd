...
@section('title', __('Add New Brand'))
        ...
        <div class="container pb-6">
            <div class="py-5">
                <div class="row g-4 align-items-center">
                    <div class="col">
                        ...
                        <h1 class="h3 m-0">{{ __('New brand') }}</h1>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-md-8 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('dashboard.brand.store') }}" class="needs-validation"
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="mt-5">
                                        <img src="" id="logoToShow" width="100" height="100"
                                            class="img-fluid" />
                                    </div>
                                </div>
                                <div class="mb-5">
