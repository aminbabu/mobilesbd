                ...
                <div class="py-5">
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-auto d-flex">
                            {{-- Delete user form --}}
                            <form id="" method="post"
                                action="{{ route('dashboard.user.destroy', ['id' => $user->id]) }}" class="needs-validation"
                                novalidate="">
                                @csrf
                                @method('delete')
                                <button type="submit" class="btn btn-secondary me-3">{{ __('Delete') }}</button>
                            </form>
                            {{-- Delete user form --}}
                            ...
                            <div class="card mt-5">
                                    ...
                                    <div>
                                        <div class="dropdown">
                                            <button class="btn btn-sa-muted btn-sm" type="button"
                                                id="address-context-menu-0" data-bs-toggle="dropdown"
                                ...
                                <div class="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                    ...
                                    <div>
                                        <div class="dropdown">
                                            <button class="btn btn-sa-muted btn-sm" type="button"
                                                id="address-context-menu-1" data-bs-toggle="dropdown"
                                                aria-expanded="false" aria-label="More">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="3" height="13"
                                                    fill="currentColor">
                                                    <path
