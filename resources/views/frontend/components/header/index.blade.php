            ...
            <div class="search-box">
                ...
                <form>
                    <div class="input-group">
                        ...
                        <div>
                            <select name="query" class="nice-select small wide">
            ...
            <ul class="nav d-block d-lg-flex fw-bold">
                ...
                <li class="nav-item drop-menu border-bottom border-2 py-1 position-relative">
                    ...
                    <ul class="dropdown-menu collection d-block p-0 top-100 rounded-0 border-0">
                        <li class="nav-item">
                            <a href="comparision.html" class="dropdown-item nav-link border-bottom">{{ __('Comparision')
                                }}</a>
                        </li>
                        <li class="nav-item">
                            <a href="contact.html" class="dropdown-item nav-link border-bottom">{{ __('Contact Us')
                                }}</a>
                        </li>
                        <li class="nav-item">
