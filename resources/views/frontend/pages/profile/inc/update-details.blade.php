<div class="card">
    <div class="card-header p-3 d-flex align-items-center justify-content-between">
        <h2 class="mb-0 h5 me-3">{{ __('Profile Details') }}</h2>
    </div>
    <div class="card-body">

        <form method="POST" action="{{ route('profile.details', ['role' => $user->role->name,'id' => $user->id]) }}"
            ...
            <div class="mb-3">
                ...
                <select name="country" class="nice-select wide @error('country') is-invalid @enderror">
            ...
            <div class="mb-3">
                ...
                <select name="status" class="nice-select wide @error('status') is-invalid @enderror">
