...
<div class="alert alert-success alert-sa-has-icon alert-dismissible-aminate my-2 fade show" role="alert">
    ...
    <div class="alert-sa-content">
        {{ __('A new user profile has been created!') }}
    </div>
    <button type="button" class="sa-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
@endif
...
<div class="alert alert-success alert-sa-has-icon alert-dismissible-aminate my-2 fade show" role="alert">
    ...
    <div class="alert-sa-content">
        {{ __('The user profile has been deleted!') }}
    </div>
    <button type="button" class="sa-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
@endif
...
@if (session('status') === 'username-exists')
<div class="alert alert-warning alert-sa-has-icon alert-dismissible-aminate my-2 fade show" role="alert">
    <div class="alert-sa-icon">
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"
            stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
            class="feather feather-check-circle">
    ...
    <div class="alert-sa-content">
        {{ __('The username has already been exists! Please, try an unique username!') }}
    </div>
    <button type="button" class="sa-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>
@endif